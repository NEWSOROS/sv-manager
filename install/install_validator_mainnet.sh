...
cd /mnt/solana/snapshots/remote && wget --trust-server-names http://api-solana.a4.finance:8899/snapshot.tar.bz2
cd /mnt/solana/snapshots/remote && wget --trust-server-names http://api-solana.a4.finance:8899/incremental-snapshot.tar.bz2
